...
@interface MyBBTableViewManager : NSObject<ASTableViewDataSource, ASTableViewDelegate>
...
- (instancetype)initWithTableView:(ASTableView *)tableView delegate:(id<MyBBTableViewManagerDelegate>)delegate;
...
@protocol MyBBTableViewManagerDelegate <ASTableViewDelegate>
